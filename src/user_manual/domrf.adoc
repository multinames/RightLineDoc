...
`sudo systemctl start sbp-connect-domrf-dashboard` - запуск службы dashboard-app

`sudo systemctl stop sbp-connect-domrf-dashboard` - остановка службы dashboard-app

`sudo systemctl status sbp-connect-domrf-dashboard` - проверка состояния client-app
